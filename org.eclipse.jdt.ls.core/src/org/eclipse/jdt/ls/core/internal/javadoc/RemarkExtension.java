 ...
 *
 * <p>
 * Basic usage involves instantiating this class with a specific set of options,
 * and calling one of the {@code convert*} methods on some form of input.
 * </p>
 *
 * <p>
 * Examples:
...
public class RemarkExtension {
	 ...
	 *
	 * @param options
	 *            Specified options to use on this instance. See the docs for the
	 *            Options class for common options sets.
	 */
	public RemarkExtension(Options options) {
		this.options = options.getCopy();
		Whitelist whitelist = Whitelist.basicWithImages().addTags("div", "h1", "h2", "h3", "h4", "h5", "h6", "table", "tbody", "td", "tfoot", "th", "thead", "tr", "hr", "span", "font").addAttributes("th", "colspan", "align", "style")
				.addAttributes("td", "colspan", "align", "style").addAttributes(":all", "title", "style").addProtocols("a", "href", "file", "jdt");
	...
	/**
	 * To see the cleaned and processed HTML document, set this to true. It will be
	 * rendered to {@code System.out} for debugging purposes.
	 *
